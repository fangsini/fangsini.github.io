			...
			<div class="main">
				<div class="log">
					...
					if(isset($_SESSION['userid'])) {
						echo "欢迎 "."<span class='red'>".user::getUserName($_SESSION['userid'])."</span>"."，";
				...
				<form action="Controllers/index.php" method="POST" class="first">
				...
				<ul>
					...
					<li>
						...
						<span class="response" onclick="show_form(<?=$row['id']?>);">回复</span>
